		...
		<div class="container">
			<div class="row align-items-center justify-content-between pt-5">
				...
				<div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
					<div class="img-wrap">
						<img src="images/headline.jpg" alt="Image" class="img-fluid rounded">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-lg-7 mb-4 mb-lg-0">
					<img src="images/headline.png" alt="Image" class="img-fluid rounded
					">
				</div>
				<div class="col-lg-4 ps-lg-2">
					<div class="mb-5">
						<h2 class="text-black h4">Pelayanan cepat dan transaksi cepat.</h2>
						<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laudantium quam eius doloremque pariatur tempora ab!</p>
					</div>
					<div class="d-flex mb-3 service-alt">
						...
						<div>
							<h3>Kebutuhan</h3>
							<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nam voluptate adipisci dolore natus eveniet quibusdam.</p>
						</div>
					</div>
					...
					<div class="d-flex mb-3 service-alt">
						...
						<div>
							...
							<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Deserunt temporibus, ratione quas sit laboriosam ad.
							</p>
						</div>
					</div>
			...
			<div class="row g-5">
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
					<div class="feature d-flex">
						...
						<div>
							...
							<p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Labore neque dolores a quidem ad perferendis.</p>
						</div>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<div class="feature d-flex">
						...
						<div>
							<h3>Investasi untuk masa depan</h3>
							<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reprehenderit fuga pariatur provident dolorem quibusdam recusandae. </p>
						</div>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
					<div class="feature d-flex">
						...
						<div>
							<h3>Cepat tanggap</h3>
							<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aperiam minima beatae numquam qui non placeat!</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 order-lg-2 mb-4 mb-lg-0">
					<img src="images/fas.jpg" alt="Image" class="img-fluid">
				</div>
				<div class="col-lg-5 pe-lg-5">
					<div class="mb-5">
						<h2 class="text-black h4">Menuju yang terdepan</h2>
					</div>
					<div class="d-flex mb-3 service-alt">
						<div>
							<span class="bi-wallet-fill me-4"></span>
						...
						<div>
							<h3>Build website</h3>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae illo culpa rem, sequi itaque vitae?</p>
						</div>
					</div>
					...
					<div class="d-flex mb-3 service-alt">
						...
						<div>
							<h3>Investasi untuk masa depan</h3>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae expedita modi voluptatibus sint facilis! Ipsa.</p>
						</div>
					</div>
					...
					<div class="d-flex mb-3 service-alt">
						...
						<div>
							<h3>cepat tanggap</h3>
							<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Officiis dolores commodi, vitae vel numquam itaque!</p>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container">
		<div class="row mb-5">
			<div class="col-lg-5 mx-auto text-center" data-aos="fade-up">
				<h2 class="heading text-primary">Pelayanan Kami</h2>
				<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore culpa, magnam nostrum autem nisi aut. </p>
			</div>
		</div>
...
<div class="section sec-cta overlay" style="background-image: url('images/fas.jpg')">
	<div class="container">
	...
	<div class="container">
		<div class="row mb-5">
			<div class="col-lg-5 mx-auto text-center ">
				<h2 class="heading text-primary mb-3" data-aos="fade-up" data-aos-delay="0">Info Terbaru Kami</h2>
		...
		<div id="post-slider" class="post-slider">
			<div class="item">
				<a href="case-study.html" class="card d-block">
					<img src="images/headline.jpg" class="card-img-top" alt="Image">
					<div class="card-body">
			...
			<div class="testimonial-slider" id="testimonial-slider">
				<div class="item">
					<div class="testimonial-half d-lg-flex bg-white">
						<div class="img" style="background-image: url('images/logo.png')">
...
<div class="section sec-news">
	<div class="container">
		<div class="row mb-5">
			<div class="col-lg-7">
				<h2 class="heading text-primary">Berita Terbaru Kami</h2>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-4">
				<div class="card post-entry">
					<a href="single.html"><img src="images/headline.jpg" class="card-img-top" alt="Image"></a>
					<div class="card-body">
						<div><span class="text-uppercase font-weight-bold date">02 Maret 2024</span></div>
						<h5 class="card-title"><a href="halaman1">Behind the word mountains</a></h5>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
			...
			<div class="col-lg-4">
				<div class="card post-entry">
					<a href="single.html"><img src="images/fas.jpg" class="card-img-top" alt="Image"></a>
					<div class="card-body">
						<div><span class="text-uppercase font-weight-bold date">Jan 20, 2023</span></div>
...
<div class="site-footer">
	<div class="container">
		...
		<div class="row mt-5">
            ...
            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed with love Distributed By Ramz</a> <!-- License information: https://untree.co/license/ -->
            </p>
          </div>
        </div>
      </div> <!-- /.container -->
