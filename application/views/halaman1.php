...
<head>
  ...
  <title>Demo Website &mdash; Halaman1</title>
</head>
<body>
			...
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					<div class="row g-0 align-items-center">
						<div class="row-5">
							<a href="home" class="logo m-0 float-start">Demo Website Halaman 1<span class="text-primary">.</span></a>
						</div>
  ...
  <div class="hero overlay inner-page">
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center pt-5">
        <div class="col-lg-6">
          <p data-aos="fade-up" class="meta">by <a href="#">Ramz</a> &bullet; on <a href="#">Mar 2th, 2024</a> </p>
          <h1 class="heading text-white mb-3" data-aos="fade-up" data-aos-delay="100">Demo Website</h1>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row mt-5">
        <div class="col-12 text-center">
          <!-- 
            ...
            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed with love Distributed By Ramz</a>
            </p>
          </div>
        </div>
      </div> <!-- /.container -->
