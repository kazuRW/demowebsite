...
<head>
	...
	<title>Demo Website &mdash; Tentang Kami</title>
</head>
<body>
			...
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					<div class="row g-0 align-items-center">
						<div class="row-5">
							<a href="home" class="logo m-0 float-start">Demo Website Halaman About<span class="text-primary">.</span></a>
						</div>
	...
	<div class="hero overlay inner-page">
		...
		<div class="container">
			<div class="row align-items-center justify-content-center text-center pt-5">
				<div class="col-lg-6">
					<h1 class="heading text-white mb-3" data-aos="fade-up">Tentang Kami</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="section sec-halfs py-0">
		<div class="half-content d-lg-flex align-items-stretch">
			<div class="img" style="background-image: url('images/headline.jpg')" data-aos="fade-in" data-aos-delay="100">
		...
		<div class="half-content d-lg-flex align-items-stretch">
			<div class="img order-md-2" style="background-image: url('images/headline.png')" data-aos="fade-in">
